...
$(MODEL):
	@mkdir -p models && cd models && \
		...
		curl --output stories15M_MOE-F16.gguf -L https://huggingface.co/ggml-org/stories15M_MOE/resolve/main/stories15M_MOE-F16.gguf && \
		curl --output moe_shakespeare15M.gguf -L https://huggingface.co/ggml-org/stories15M_MOE/resolve/main/moe_shakespeare15M.gguf
