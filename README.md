...
The project provides a cython wrappers of @ggerganov's [llama.cpp](https://github.com/ggerganov/llama.cpp) which is likely the most active open-source compiled LLM inference engine. It is a further spin-off of the [llamalib](https://github.com/shakfu/llamalib) project in which the wrapping of llama.cpp began using [cython](https://github.com/cython/cython), [pybind11](https://github.com/pybind/pybind11), and [nanobind](https://github.com/wjakob/nanobind). Since, the cython wrapper ended up being the most mature, it was spun-off and further wrapping will continue in this project.
